...
/**
 * A trivial JAX-RS application that registers a single resource and configures the FlatPack adapters.
 */
    ...
    extends Application
{
    ...
    /**
     * In a production system, this would typically be implemented as a query on the underlying database.
     */
    private class FakeDatabaseResolver
    ...
    public Set<Object> getSingletons()
    {
        ...
        /*
         * The EntityResolver is optional and is used when FlatPack deserializes a payload to retrieve a persistent
         * entity to which properties in the incoming payload will be applied. Implementors that do not that need to
         * manually merge incoming DTOs with persistent state may omit this configuration.
         */
         ...
         * ensure that a Customer can only mutate properties that have an @InheritPrincipal chain back to the Customer.
         */
        /* .withPrincipalMapper( new DemoPrincipalMapper() ) */
        /*
         * A RoleMapper enables role-based property access, which restricts property getters and setters based on
         * @PermitAll / @DenyAll / @RolesAllowed annotations. Beyond just simple security measures, roles can be used to
         * create sets of properties to reduce payload sizes (e.g. "CustomerSummary" vs. "CustomerDetail").
         */
