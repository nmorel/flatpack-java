...
class PostWorkComparator implements Comparator<Callable<?>> {
  ...
  public int compare(Callable<?> o1, Callable<?> o2) {
    PostWorkOrder a1 = o1.getClass().getAnnotation(PostWorkOrder.class);
    PostWorkOrder a2 = o2.getClass().getAnnotation(PostWorkOrder.class);

    int v1 = a1 == null ? 0 : a1.value();
    int v2 = a2 == null ? 0 : a2.value();
    return v1 - v2;
  }
